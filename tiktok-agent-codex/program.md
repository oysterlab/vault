You are Codex operating this TikTok art content workspace. Execute ALL phases below in order. Do NOT stop early. If any phase fails, skip it and continue to the next phase. Phase 4 (notes.md update) is ALWAYS executed no matter what.
...
- Read docs/strategy.md for hook formulas and constraints
...
If create_post fails (e.g., image download error), debug it and retry with a fixed URL or a different painting. Do NOT stop the session.
